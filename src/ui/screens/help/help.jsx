    ...
    <div className="help-container">
      ...
      <div className="help-container__info">
        <div className="andreo">
          ...
          <p>E lembre-se, sempre que precisar de ajuda, clique no botão azul <strong><em>Ajuda</em></strong> e encontre
          ...
          <table>
            ...
            <tr>
              <td>Esquerdo</td>
              <td>É o que faz uma ação, se clicar com o botão esquerdo do mouse em um botão o computador fará a ação que
                o botão informa.
              </td>
              <td><img class="img" alt="" src={leftMouse}/></td>
            </tr>
            <tr>
              <td>Direito</td>
              <td>Quando clicado, geralmente mostra todas as opções de ações que o usuário pode ter.</td>
              <td><img class="img" alt="" src={rightMouse}/></td>
            </tr>
            <tr>
              <td>Rodinha</td>
              <td>Pode ser utilizada para descer ou subir a tela</td>
              <td><img class="img" alt="" src={scroolMouse}/></td>
            </tr>
            </tbody>
          </table>
          ...
          <ol>
            <li>Se você estiver em um notebook, deve usar o touchpad. Onde voce vai arrastar o dedo em cima para mover o
              mouse.
          ...
          <p>Para digitar acentos, procure o botão que tem seu acento no teclado. São duas opções o acento primário e o
            secundário.</p>
          <p>Para colocar o acento em uma letra, clique primeiramente no botão do acento e depois na letra em que deseja
            coloca-la.</p>
          ...
          <p>Ao clicar no campo, as letras <strong>dd</strong> ficam azuladas, nesse momento se você digitar um numero,
          ...
          <p>Dica: Para procurar coisas nas listas, após clicar você pode digitar parte do qnome que procura e o seletor
